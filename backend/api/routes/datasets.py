...
# from core.auto_labeler import auto_labeler  # COMMENTED OUT (manual labeling only)
# from models.model_manager import model_manager  # COMMENTED OUT (manual labeling only)
