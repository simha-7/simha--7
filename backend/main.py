...
from api.routes import projects, datasets, annotations, enhanced_export, releases
# from api.routes import models  # COMMENTED OUT (manual labeling only)
...
# from api import active_learning  # COMMENTED OUT (manual labeling only)
...
# app.include_router(models.router, prefix="/api/v1/models", tags=["models"])  # COMMENTED OUT (manual labeling only)
...
# app.include_router(active_learning.router, tags=["active-learning"])  # COMMENTED OUT (manual labeling only)
